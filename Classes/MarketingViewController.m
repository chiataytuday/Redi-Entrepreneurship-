...
- (void)viewDidLoad {
	...
	self.dc.partsOfPlan = [self.dc.db getInputFieldsForSection:3 BusinessID:self.dc.curBusID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [self.dc.partsOfPlan objectAtIndex:indexPath.row];
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	detailViewController.label.text = self.dc.fieldName;
