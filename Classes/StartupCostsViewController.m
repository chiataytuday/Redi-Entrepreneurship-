...
@implementation StartupCostsViewController
@synthesize del;
@synthesize dc;
@synthesize startupCell;
#pragma mark -
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.dc.startupCosts count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	static NSString *CellIdentifier = @"StartupCell";
    
    StartupCostCell* cell = (StartupCostCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        [[NSBundle mainBundle] loadNibNamed:@"StartupCostCell" owner:self options:nil];
		cell = self.startupCell;
		
    }
	
    // Configure the cell...
	StartupCost* sc = [self.dc.startupCosts objectAtIndex:indexPath.row];
    cell.textLabel.text = sc.name;
	cell.needed.text = [NSString stringWithFormat:@"%d", sc.needed];
	cell.purchased.text = [NSString stringWithFormat:@"%d", sc.purchased];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.dc.curStartupCost = [self.dc.startupCosts objectAtIndex:indexPath.row];
